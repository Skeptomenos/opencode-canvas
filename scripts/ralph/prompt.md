...
**Use the Playwright MCP or chrome-devtools tools:**

1. Navigate to the relevant page using browser tools
2. Interact with the UI to verify changes work as expected
3. Take a screenshot if helpful for documentation
4. Confirm the acceptance criteria are met visually

**Available browser tools:**

- `chrome-devtools_navigate_page` - Navigate to URLs
- `chrome-devtools_take_snapshot` - Get page content/structure
